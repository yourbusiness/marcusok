...
- 05cfb31: Fix a batch of silent-data-loss and hang-prone edge cases found in a repo-wide review, and tighten a few validation/docs points.
...
- 14fdb52: Fix the shared progress overlay rendering the wrong caller's text during concurrent exports, and clarify a few docs/config points found in a repo-wide review.
...
- 34d39b3: Fix silent data loss when a user column claims the reserved `__index__` prop without `indexColumn` being enabled.
